...
# написать модель которая будет получать 264450 возвращать 6
# определить как опиздюливать модель и хвалить
# написать функцию управления игрой
# написать метод для получения 4х изображений в секунду
